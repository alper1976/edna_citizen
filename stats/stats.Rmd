...
cairo_ps(file.path(figs_dir, "ori_map.eps"), width=80/25.4, height=160/25.4, pointsize = 4, bg = FALSE, fallback_resolution = 300)
...
cairo_ps(file.path(figs_dir, "hist_map.eps"), width=80/25.4, height=160/25.4, pointsize = 4, bg = FALSE, fallback_resolution = 300)
ggmap(get_stamenmap(c(10, 58.8, 11, 60),  maptype = "toner-lite", zoom = 10)) +
