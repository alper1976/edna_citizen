...
# sequencing run
# 221202_M01334.Project_Kvalheim-Amplicon1-2022-11-18
# Fish
...
option_list = list(
    ...
    make_option(c("-p", "--path"),
        type="character",
        default="/cluster/projects/nn9745k/02_results/26_lone/AdaptersRemoved",
        help="path to input",
        metavar="character"),

    make_option(c("-o", "--output"),
        type="character",
        default="/cluster/projects/nn9745k/02_results/26_lone",
        help="path to output",
        metavar="character"),
...
error_fwd <- learnErrors(filtered_fwd, nbases=1e7, randomize = TRUE, multithread=FALSE)
# Learn reverse error rates
error_rev <- learnErrors(filtered_rev, nbases=1e7, randomize = TRUE, multithread=FALSE)
